                    ...
                    >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="text" required autofocus name="name" id="name" value="{{$submenu->name}}" class="form-control">
                            </div>
                        </div>
                        <?php $mainmenus = DB::table('main_menus')->orderBy('name', 'asc')->where('active',1)->get();?>
                        <div class="form-group row">
                            <label for="parent" class="control-label col-lg-1 col-sm-2">
                            	Parent <span class="text-danger">*</span>
                            </label>
                            <div class="col-lg-6 col-sm-8">
                            <select name="parent" id="parent" class="form-control">
                                @foreach($mainmenus as $m)
                                    <option value="{{$m->id}}" {{$m->id==$submenu->parent_id?'selected' : ''}}>{{$m->name}}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="text" name="url" id="url" value="{{$submenu->url}}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="number" name="order_number" id="order_number" value="{{$submenu->order_number}}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
